...
* **The Echo System (Level 70+):** Once you hit Level 70, you stop gaining standard levels. EXP goes toward "Echo Levels" (an infinite pinnacle progression system). Every Echo Level grants 1 Echo Point.
* **Echo Point Allocation:** Points are spent on infinite, fractional micro-stats across 3 pools:
  * *Offense:* +0.1% Critical Hit Chance (Cap: 10%), +0.2% Crit Damage, +0.25% Boss Damage, +0.1% Attack/Cast Speed.
  * *Defense:* +0.2% All-Resist (up to 75% cap), +2 Flat Reflect & +0.15% Damage Reflect, +0.1% Evasion (Evade), +0.2% Total Armor.
  * *Utility:* +0.15% Cooldown Reduction (CDR), +0.1% Life Steal, +0.5% Gold Drop Rate, +0.5% Magic Find (Luck), +0.2% Resource Generation.
