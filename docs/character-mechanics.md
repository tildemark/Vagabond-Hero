...
* **[Lv 1] Scavenger's Strike:** A basic attack dealing 100% Weapon Damage. 10% chance to dislodge 1-5 Gold from the enemy. (Cooldown: 0 Turns)
* **[Lv 5] Patch Up:** Restores 15% of Max HP. Cannot be used if Poisoned or Bleeding. (Cooldown: 4 Turns)
* **[Lv 15] Desperate Flee:** Attempt to run from combat. 50% success rate. Fails automatically against Bosses. (Cooldown: 1 Turn)

---

## 3. Phase 2: First Job Awakening (Levels 21 - 50)

At Level 20, the player selects one of four base classes. Combat shifts to utilizing Mana/Stamina and managing cooldowns.

### Juggernaut (Strength Focus)

* **[Lv 21] Heavy Smash:** Deals 140% Physical Damage. Reduces enemy Evasion by 10% for 2 turns. (Cooldown: 2 Turns)
* **[Lv 30] Taunt:** Forces the enemy to target you instead of your Companion. Increases your Armor by 25% for 3 turns. (Cooldown: 4 Turns)
* **[Lv 45] Earthshatter:** AoE attack. Deals 110% Physical Damage to all enemies in the room. (Cooldown: 5 Turns)

### Phantom (Agility Focus)

* **[Lv 21] Flurry:** Strikes twice, each hit dealing 70% Finesse Damage. High chance to trigger on-hit effects. (Cooldown: 0 Turns)
* **[Lv 30] Venom-Laced Blade:** Your next attack applies a Poison DoT, dealing 20% of your AGI as damage per turn for 4 turns. (Cooldown: 3 Turns)
* **[Lv 45] Smoke Bomb:** Instantly increases Evasion to 80% for 1 turn. (Cooldown: 6 Turns)

### Weaver (Intelligence Focus)

* **[Lv 21] Arcane Bolt:** Deals 130% Magic Damage. Never misses. (Cost: 10 Mana, Cooldown: 0 Turns)
* **[Lv 30] Siphon Energy:** Deals 50% Magic Damage and restores Mana equal to the damage dealt. (Cooldown: 3 Turns)
...
### Warden (Summon/Utility Focus)

* **[Lv 21] Summon Void-Pup:** Summons a beast with 30% of your HP. It automatically attacks every turn for 50% of your INT. (Cooldown: 8 Turns)
* **[Lv 30] Leeching Vines:** Entangles an enemy, dealing 80% Magic Damage and healing you for 50% of the damage dealt. (Cooldown: 3 Turns)
* **[Lv 45] Shared Burden:** Transfers all your active debuffs (Poison, Chill) to your Summon. (Cooldown: 4 Turns)

---

## 4. Phase 3: Second Job (Levels 51 - 70)

Advanced classes branch into pure offense, pure defense, or hybrid utility.
...
## 5. Phase 4: Third Job / Pinnacle Classes (Level 70+)
